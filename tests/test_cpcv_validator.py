"""Tests for cpcv_validator.py. Same "synthetic first, empty/degenerate
input before happy path" workflow as tests/test_walk_forward_validator.py.
Pure combinatorics
(generate_cpcv_splits, _contiguous_runs) tested directly with no DataFrame;
classify_cpcv_overall() tested directly against synthetic verdict lists;
cpcv_validate() tested end-to-end on small synthetic panels last."""
import numpy as np
import pandas as pd
import pytest
